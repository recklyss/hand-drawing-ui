...
[![npm version](https://badge.fury.io/js/hand-drawing-ui.svg)](https://www.npmjs.com/package/@recklyss/hand-drawing-ui)
...
1. Clone the repository:
   ```sh
   git clone https://github.com/recklyss/hand-drawing-ui.git
   cd hand-drawing-ui
   ```
